...
export default function Navbar() {
  ...
  return (
    <nav className="flex p-4 gap-10 border-b-1 border-gray-200 w-full relative lg:fixed lg:z-50">
      ...
      <div className="flex">
        <ul className={`${toggleNavbar===false ? 'hidden' : 'flex flex-col pt-16 pb-4 bg-personallightblue'} lg:flex lg:flex-row lg:py-0 lg:bg-inherit items-center w-full gap-10 lg:w-1/2 absolute top-0 left-0 lg:static`}>
      ...
      <div onClick={() => setToggleNavbar(!toggleNavbar)} className="flex flex-col lg:hidden gap-1 z-10 ml-auto w-[2.3rem] h-6">
