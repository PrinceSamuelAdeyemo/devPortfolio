            ...
            <div className="flex flex-col gap-10 lg:gap-24 pb-32 pt-16">
                ...
                <div className="py-28 bg-gradient-to-r from-white via-personalpurple via-50% to-white to-95%">
                    <div className="flex flex-col items-center gap-4">
                        <p className="text-2xl lg:text-5xl font-bold">Backend Development</p>
                        <p className="text-base text-gray-600 text-center w-[90%] md:w-[50%] lg:w-[30%]">Crafting robust, scalable, and secure server-side solutions that power modern applications. Explore my deep understanding of backend systems and architecture.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-8 lg:gap-20 items-center">
                    ...
                    <div className="flex flex-col gap-6 w-4/5">
                        <p className="font-semibold text-xl lg:text-2xl text-center ">Core Backend Skills</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-2 xl:gap-4">
                            {
                    ...
                    <div className="flex flex-col gap-6 w-4/5">
                        <p className="font-semibold text-xl lg:text-2xl text-center ">Featured Backend Projects</p>
                    ...
                    {/* Articles/Writeups */}
                    <div className="flex flex-col gap-6 w-4/5">
                        <p className="font-semibold text-xl lg:text-2xl text-center ">Backend Architecture Spotlights</p>
                        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {/* <FeaturedProject />
                            <FeaturedProject />
                            <FeaturedProject /> */}
